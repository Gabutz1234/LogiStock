<div class="header-actions">
    ...
    <form method="POST" action="warehouses.php" class="card" style="padding: 1rem; display: flex; gap: 1rem; align-items: flex-end; margin-bottom: 0;">
        ...
        <div class="form-group" style="margin-bottom: 0;">
            ...
            <input type="number" step="0.01" name="min_temperature" required placeholder="-25">
        </div>

        <div class="form-group" style="margin-bottom: 0;">
            <label>Suhu Maksimum (°C)</label>
            <input type="number" step="0.01" name="max_temperature" required placeholder="-18">
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?= htmlspecialchars($w['min_temperature']) ?> °C
                    </td>

                    <td>
                        <?= htmlspecialchars($w['max_temperature']) ?> °C
                    </td>

                    <td>
                        <button class="btn" style="opacity: 0.5;">
                            Ubah
                        </button>
                    </td>
